...
@Composable
fun DateRangePickerPlayground() {
    var range by rememberSaveable(stateSaver = finsibleDateRangeSaver) { mutableStateOf(FinsibleDateRange.Empty) }
    ...
    Column(
        ...
        FinsibleText(
            text = stringResource(
                R.string.component_playground_daterange_label,
