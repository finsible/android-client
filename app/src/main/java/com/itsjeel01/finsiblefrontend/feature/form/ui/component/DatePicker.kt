...
import com.itsjeel01.finsiblefrontend.ui.common.component.input.FinsibleDateInput
...
fun NewTransactionDatePicker(modifier: Modifier = Modifier) {
    ...
    val transactionDate = transactionFormViewModel.transactionDateState.collectAsState().value ?: System.currentTimeMillis()
