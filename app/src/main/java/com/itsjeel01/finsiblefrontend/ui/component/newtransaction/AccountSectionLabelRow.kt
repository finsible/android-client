...
/** Section label row for an account expandable row.
 * Displays the [label] (e.g. "FROM" / "TO") with an optional [hint] ("Frequent")
 * and a trailing "All" micro button that opens the bottom sheet.
 */
@Composable
fun AccountSectionLabelRow(
    label: String,
    onOpenAll: () -> Unit,
    accentColor: Color,
