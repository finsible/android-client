...
val AppTypography = Typography(
    ...
    // Label -> Serif
    labelLarge = baseline.labelLarge.copy(fontFamily = serifFont).copy(fontSize = 22.sp),
    labelMedium = baseline.labelMedium.copy(fontFamily = serifFont).copy(fontSize = 16.sp),
    labelSmall = baseline.labelSmall.copy(fontFamily = serifFont).copy(fontSize = 14.sp),
)