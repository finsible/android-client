...
@HiltViewModel
class NewTransactionFormViewModel @Inject constructor(private val categoryLocalRepository: CategoryLocalRepository) :
    ViewModel() {
    ...
    private val _currentCategoriesState =
        MutableStateFlow(categoryLocalRepository.getAllCategories()
    ...
    private val _transactionCategoryState =
        MutableStateFlow(currentCategoriesState.value.first())
    val transactionCategoryState: MutableStateFlow<CategoryEntity> = _transactionCategoryState
    ...
    fun setTransactionType(transactionType: TransactionType) {
        ...
        if (transactionType != TransactionType.TRANSFER) loadCategories()
    }
